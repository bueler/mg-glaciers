...
\begin{abstract}  This note describes the full approximation storage (FAS) scheme for an easy one-dimensional nonlinear boundary value problem.  We apply both V-cycles and F-cycles to solve the problem by a simple finite element (FE) scheme, and we emphasize the  mathematical structure of the FE case.  An accompanying Python program implements the scheme.
\end{abstract}
