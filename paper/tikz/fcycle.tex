...
% coarse solve only
  ...
  \draw[black,double,line width=0.5mm,double distance=0.5mm,shorten <=1mm] (-4*\hstep,0.0) -- (-3*\hstep,\vstep);
...
% 2-level V-cycle
  ...
  \draw[black,double,line width=0.5mm,double distance=0.5mm,shorten <=1mm] (-\hstep,\vstep) -- (0.0,2*\vstep);
...
% 3-level V-cycle
  ...
  \draw[black,double,line width=0.5mm,double distance=0.5mm,shorten <=1mm] (4*\hstep,2*\vstep) -- (5*\hstep,3*\vstep);
