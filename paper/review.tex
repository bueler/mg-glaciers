...
\caption{\emph{Top.}  Cross-section of the Greenland ice sheet at $69^\circ$N latitude, showing surface $s$ and bed $b$.  \emph{Bottom.} The corresponding thickness $H=s-b$.  \emph{Inset.} Location of transect.}
\label{fig:giscross}
\end{figure}
