...
FIXME describe nested iteration; give pseudocode \pr{mcdl-fcycle}; mention V(1,1) in Appendix B

\subsection*{Computational results} FIXME error norms for slash cycle on two problems: icelike and parabola; demonstrates convergence rate
