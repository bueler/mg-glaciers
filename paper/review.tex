...
\caption{For analogy only:  A 2-dimensional constrained-minimization, or VI solution, in a planar quadrant $\mathcal{Q}$, with contours of a scalar objective $\gamma(x)$.}
