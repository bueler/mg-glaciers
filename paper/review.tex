...
\end{itemize}
We test these solvers on the ``icelike'' problem but with a more generic random bed, like the one shown in Figure \ref{fig:icelikedecomposition}.  In all cases we do slash cycles until convergence, i.e.~\eqref{eq:cpconvergencecriterion} with \id{rtol} $=10^{-4}$.
