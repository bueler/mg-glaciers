...
FIXME explain WU; figure with WU on $y$-axis and $N$ on $x$-axis for PGS only, slash cycle, V(2,0), F-cycle, and 2-iterations-on-way-up-F-cycle (5 solvers) on two problems: icelike and icelike-with-random-bed

FIXME \cite{Blumetal2004} on cascadic and CG variants

FIXME figure showing run time per degree of freedom for same runs
