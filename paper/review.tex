...
\end{equation}
(This is essentially the same source term as in a standard FAS scheme \cite{Trottenbergetal2001}.)  The final form of the coarse-correction VI rewrites \eqref{eq:siaVIFEFASearly} by moving already-computed quantities, namely the source term \eqref{eq:siaell}, to the right:
\begin{equation}
